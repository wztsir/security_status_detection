...
import Earth from "./earth.min.js";
...
let e = new Earth("container", cityList, bizLines, { autoRotate: true, zoomChina: false, starBackground: true, orbitControlConfig: { enableRotate: true } });
e.load()
...
experienceBtn.addEventListener("click", function () {
    // 拼接相对路径
    const newPath = "../equipment/equipment.html";
